        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> TOOLS_AND_ARMOR_OPTIONS.enableRubyGear,
                    newValue -> TOOLS_AND_ARMOR_OPTIONS.enableRubyGear = newValue)
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> TOOLS_AND_ARMOR_OPTIONS.enableSapphireGear,
                    newValue -> TOOLS_AND_ARMOR_OPTIONS.enableSapphireGear = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> TOOLS_AND_ARMOR_OPTIONS.enableTanzaniteGear,
                    newValue -> TOOLS_AND_ARMOR_OPTIONS.enableTanzaniteGear = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> TOOLS_AND_ARMOR_OPTIONS.enableSteelGear,
                    newValue -> TOOLS_AND_ARMOR_OPTIONS.enableSteelGear = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> TOOLS_AND_ARMOR_OPTIONS.enableObsidianGear,
                    newValue -> TOOLS_AND_ARMOR_OPTIONS.enableObsidianGear = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> TOOLS_AND_ARMOR_OPTIONS.enableEmeraldGear,
                    newValue -> TOOLS_AND_ARMOR_OPTIONS.enableEmeraldGear = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> TOOLS_AND_ARMOR_OPTIONS.enableCopperTools,
                    newValue -> TOOLS_AND_ARMOR_OPTIONS.enableCopperTools = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .build();
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> RECIPE_OPTIONS.enableHorseArmorRecipes,
                    newValue -> RECIPE_OPTIONS.enableHorseArmorRecipes = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> RECIPE_OPTIONS.enableChainmailRecipes,
                    newValue -> RECIPE_OPTIONS.enableChainmailRecipes = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> RECIPE_OPTIONS.enableRawSmeltingRecipes,
                    newValue -> RECIPE_OPTIONS.enableRawSmeltingRecipes = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .option(
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> RECIPE_OPTIONS.enableUncraftingRecipes,
                    newValue -> RECIPE_OPTIONS.enableUncraftingRecipes = newValue)
                .customController(BooleanController::new)
                .flag(EnrichedOptionCategories.RELOAD_DATA_PACKS)
                .build())
        .build();
    ...
    return ConfigCategory.createBuilder()
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    EnrichedGameOptions.defaults().mobOptions.enableHoneySlimeSpawning,
                    () -> MOB_OPTIONS.enableHoneySlimeSpawning,
                    newValue -> MOB_OPTIONS.enableHoneySlimeSpawning = newValue)
                .customController(BooleanController::new)
                .build())
        .build();
  }
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> WORLD_GENERATION.generateRubyOres,
                    newValue -> WORLD_GENERATION.generateRubyOres = newValue)
                .customController(BooleanController::new)
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> WORLD_GENERATION.generateSapphireOres,
                    newValue -> WORLD_GENERATION.generateSapphireOres = newValue)
                .customController(BooleanController::new)
                .flag(OptionFlag.GAME_RESTART)
                .build())
        .option(
        ...
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> WORLD_GENERATION.generateDarkGranite,
                    newValue -> WORLD_GENERATION.generateDarkGranite = newValue)
                .customController(BooleanController::new)
                .flag(OptionFlag.GAME_RESTART)
                .build())
        .option(
            Option.<Boolean>createBuilder()
                ...
                .binding(
                    ...
                    () -> WORLD_GENERATION.generateMarble,
                    newValue -> WORLD_GENERATION.generateMarble = newValue)
                .customController(BooleanController::new)
                .flag(OptionFlag.GAME_RESTART)
                .build())
        .build();

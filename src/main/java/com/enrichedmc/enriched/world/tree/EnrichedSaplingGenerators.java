...
public class EnrichedSaplingGenerators
{
    ...
    static
    {
        REDWOOD = new SaplingGenerator("redwood", 0.0f, Optional.empty(), Optional.empty(),
                Optional.of(EnrichedConfiguredFeatures.REDWOOD_KEY), Optional.empty(), Optional.empty(),
                Optional.empty());
    }
}

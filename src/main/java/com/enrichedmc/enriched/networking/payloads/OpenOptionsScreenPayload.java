...
public class OpenOptionsScreenPayload implements CustomPayload {
  public static final CustomPayload.Id<OpenOptionsScreenPayload> ID =
      new CustomPayload.Id<>(EnrichedNetworking.OPEN_OPTIONS_SCREEN_PACKET);
  public static final PacketCodec<RegistryByteBuf, OpenOptionsScreenPayload> CODEC =
      new PacketCodec<>() {
        @Override

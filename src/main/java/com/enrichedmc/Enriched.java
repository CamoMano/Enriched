...
import com.enrichedmc.world.Generator;
...
public class Enriched implements ModInitializer {
    ...
    public static final String MOD_VERSION = FabricLoader.getInstance().getModContainer("enriched").get().getMetadata().getVersion().toString();

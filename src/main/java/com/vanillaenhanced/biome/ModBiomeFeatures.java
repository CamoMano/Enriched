...
public class ModBiomeFeatures {
    ...
    public static void addTaigaMobs(SpawnSettings.Builder builder) {
        builder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityType.WOLF, 8, 4, 4));
        builder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityType.FOX, 8, 2, 4));
    }

    public static void addFrozenDesertMobs(SpawnSettings.Builder builder) {
    ...
    public static void addMountainMobs(SpawnSettings.Builder builder) {

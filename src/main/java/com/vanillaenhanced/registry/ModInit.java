...
public class ModInit {
    ...
    public static void Register() {
        ...
        //block("redwood_sign", REDWOOD_SIGN);
        //blockItem("redwood_sign", REDWOOD_SIGN, ItemGroup.BUILDING_BLOCKS);
        //block("redwood_wall_sign", REDWOOD_WALL_SIGN);
        //block("redwood_wall_sign"), new WallSignBlock(FabricBlockSettings.copyOf(Blocks.SPRUCE_WALL_SIGN, SignType.SPRUCE));
